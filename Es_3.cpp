...
//funzione che genera casualmente 4 numeri
...
//funzione che chiede di inserire i 4 numeri all'utente
...
//funziona che indica i tentativi fatti indicando se i numeri messi in input dallutente sono nella posizione errata o non ci sono.
...
//funzione che grazie ad un controllo do while farà finire il programma se ci sono le condizioni di vittoria oppure se si raggiungono i tentativi massimi
void master_mind (bool *vittoria, int n_tent,int numeri[DIM])
{
...
//funzione per la verifica di vittoria o sconfitta
...
int main ()
{
	int numeri[DIM], tentativo[DIM], pos_r, pos_e,n_tentativi;
	bool vittoria;
